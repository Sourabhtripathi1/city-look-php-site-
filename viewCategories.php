			...
			<div class="col-lg-12 mx-3">
				...
				<form action="" method="post">
					<table class="table table-hover table-bordered mx-2 my-5">
						...
						?>
							<tr>
								<td><input type="checkbox" name="ids[]" id="" class="ids" value="<?php echo $r["Category_id"]  ?>"></td>
								<td><?php echo $r['Category_id']  ?></td>
								<td><?php echo $r['Category_name']  ?></td>
								<td><a href="?Delid=<?php echo $r["Category_id"] ?>">Delete</a></td>
					...
					<div class="d-flex justify-content-center">
						...
						<Input type="submit" value="Add New Category" name="ancat" class="btn btn-primary btn-sm mx-3 md-5">
