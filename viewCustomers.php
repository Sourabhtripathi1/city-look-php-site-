			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="d-sm-flex align-items-center justify-content-between mb-4">
						<h1 class="h3 mb-0 text-gray-800">View Customers</h1>
					...
					<table class="table table-hover table-bordered mx-2 my-5">
						...
						?>
							<tr>
								...
								<td><?php echo $p["E_mail"]  ?></td>
								<td><?php echo $p["House_no"] . " , " . $p["Street"] . " , " . $p["Area"] . " , " . $p["District"] . " , " . $p["State"]  ?></td>
								<td><?php echo $p["PINCODE"]  ?></td>
							</tr>
